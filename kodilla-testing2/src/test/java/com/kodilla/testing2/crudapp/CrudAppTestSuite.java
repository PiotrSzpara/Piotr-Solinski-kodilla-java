...
public class CrudAppTestSuite {
    ...
    private static final String BASE_URL = "https://piotrszpara.github.io";
    ...
    private boolean checkTaskExistsInTrello(String taskName) throws InterruptedException {
        ...
        driverTrello.findElement(By.id("user")).sendKeys("piotr.szpara@gmail.com");
        driverTrello.findElement(By.id("password")).sendKeys("Szparag123");
