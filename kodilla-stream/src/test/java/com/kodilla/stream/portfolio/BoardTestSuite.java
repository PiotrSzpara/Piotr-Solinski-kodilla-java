...
public class BoardTestSuite {
    ...
    @Test
    void testAddTaskListAverageWorkingOnTask1() {
        //Given
        Board project = prepareTestData();
        ...
        long sumOfDays = project.getTaskLists().stream()
                .filter(inProgressTasks::contains)
                .flatMap(t1 -> t1.getTasks().stream())
                .mapToInt(t -> LocalDate.now().getDayOfYear() - t.getCreated().getDayOfYear())
                .sum();
        ...
        double average = sumOfDays/tasks;
