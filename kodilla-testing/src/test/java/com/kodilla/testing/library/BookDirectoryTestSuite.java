...
public class BookDirectoryTestSuite {
    ...
    class BooksWithConditions {
        ...
        void testListBooksWithConditionFragmentShorterThan3() {
            ...
            // When
            List<Book> theListOfBooks10 = bookLibrary.listBooksWithCondition("Na");
            // Then
    ...
    @Nested
    @DisplayName("Tests for Books In Hands")

    class BooksInHands {
        @Test
        void testListBooksInHandsOfWithOBook() {
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            LibraryUser libraryUser = new LibraryUser("Adam", "Adamski", "89123456789");
            List<Book> resultListOf0Books = new ArrayList<>();
        ...
        @Test
        void testListBooksInHandsOfWith5Book() {
            BookLibrary bookLibrary = new BookLibrary(libraryDatabaseMock);
            LibraryUser libraryUser = new LibraryUser("Adam", "Adamski", "89123456789");
